...
file_path = r"D:\EEG dataset\eeg dataset\EE_PCA_1.csv"  # Update with the correct path
...
model = Sequential([
    ...
    LSTM(64, return_sequences=True),    # Another Bidirectional LSTM
...
# Save the model
model_save_path = r"D:\EEG dataset\eeg dataset\cnn_lstm_model_7.h5"  # Update with the desired save path
